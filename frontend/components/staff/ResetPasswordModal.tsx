...
export default function ResetPasswordModal({ user, onClose }: Props) {
  ...
  function handleSubmit() {
    setError('');
    if (password && password.length < 8) { setError('Parol kamida 8 ta belgi bo\'lishi kerak'); return; }
    if (password && password !== confirm) { setError('Parollar mos emas'); return; }
    if (!password && !usernameChanged) { setError('Hech narsa o\'zgartirilmadi'); return; }
    mut.mutate();
  }
    ...
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm p-4">
        <div className="bg-white rounded-3xl shadow-2xl w-full max-w-sm p-8 text-center">
          ...
          <h2 className="text-lg font-bold text-gray-900 mb-2">Yangilandi!</h2>
          <p className="text-sm text-gray-500 mb-6">
            {`${user.firstName} ${user.lastName} uchun kirish ma'lumotlari yangilandi.`}
          </p>
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm p-4">
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-sm">
        ...
        <div className="flex items-center justify-between px-6 pt-5 pb-4 border-b border-gray-100">
          <div>
            <h2 className="text-base font-bold text-gray-900">Kirish ma&apos;lumotlari</h2>
        ...
        <div className="px-6 py-5 space-y-4">
          {/* Username */}
          <div>
            <label className="text-xs font-medium text-gray-600 mb-1 block">Login (username)</label>
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-7 pr-3 py-2.5 text-sm border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500"
              />
            </div>
          </div>
          ...
          <div className="border-t border-gray-100 pt-4 space-y-4">
            ...
            <div>
              <label className="text-xs font-medium text-gray-600 mb-1 block">
                Yangi parol
                <span className="ml-1 text-gray-400 font-normal">(bo&apos;sh qoldirsangiz o&apos;zgarmaydi)</span>
              </label>
              <div className="relative">
                <input
            ...
            {/* Tasdiqlash — faqat parol kiritilganda kerak */}
            {password && (
              <div>
          ...
          <div className="flex gap-2 pt-1">
            ...
            <button
              ...
              disabled={mut.isPending || (!password && !usernameChanged) || (!!password && password !== confirm)}
