...
const TABS: Array<{ id: Tab; label: string; icon: LucideIcon }> = [
  ...
  { id: 'points',      label: 'Mening ballim', icon: Star },
  { id: 'bookclub',    label: 'Kitobxonlik',   icon: BookOpen },
  { id: 'vocab',       label: "Lug'at",        icon: BookOpen },
];
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="px-6 pt-6 pb-0 bg-white border-b border-gray-100 shrink-0">
        <div className="flex items-center gap-4 pb-4">
          <div className="w-10 h-10 rounded-2xl bg-amber-500 flex items-center justify-center text-white text-xl shrink-0"><Trophy size={16} /></div>
          ...
          {myStats && (
            <div className="flex items-center gap-2 shrink-0">
              <div className="flex items-center gap-1.5 bg-amber-50 border border-amber-200 rounded-xl px-3 py-1.5">
                ...
                <span className="text-amber-600 text-xs"><Star size={16} /></span>
              </div>
              {myStats.rank > 0 && (
